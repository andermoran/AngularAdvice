...
- What if instead I want to refer to the property as `hili` when I bind to it because I'm lazy and do not want to type highlighted?
...
## Module
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5MTkxMDAwMzIsMTY2NDQ2MjUwMCwtNj
